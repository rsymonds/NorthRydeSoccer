<html>
<head>
  <title>North Ryde Soccer - Galleries</title>
      ...
      <td class="contentarea top">
        ...
        <tr>
          <td>
            ...
            <tr>
              <td class="forte">Galleries Menu</td>
            </tr>
            ...
            <tr>
              <td>
                <table class="fullwidth galleries" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="tablesubheader galleriesmenuc1">SUBJECT</td>
                  <td class="tablesubheader galleriesmenuc2">DESCRIPTION</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="galleries_pic_of_the_week.php">Pic of the Week</a></td>
                  <td>
                    A gallery of the best photos nominated in each week's
                    <span class="italic">Pic of the Week</span> competition
                  </td>
                </tr>
                </table>
              </td>
