<html>
<head>
  <title>North Ryde Soccer - Club Details</title>
      ...
      <td class="contentarea top">
        ...
        <tr>
          <td class="titlearea">
            ...
            <tr>
              <!-- Page title -->
              <td class="title">CLUB DETAILS</td>
            </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td>
            ...
            <tr>
              <td class="forte">Club Details Menu</td>
            </tr>
            <tr><td class="spacersmallY"></td></tr>
            <tr>
              <td class="small italic">
                Click on a <span class="bold">Subject</span> to view it's content
              </td>
            </tr>
            <tr><td class="spacersmallY"></td></tr>
            <tr>
              <td>
                <table class="fullwidth clubdetails" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="tablesubheader clubmenuc1">SUBJECT</td>
                  <td class="tablesubheader clubmenuc2">DESCRIPTION</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="club_details_about.php">About</a></td>
                  <td>General information about the North Ryde Soccer Club</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="club_details_contacts.php">Contacts</a></td>
                  <td>Contact details of the NRSC board of directors and committee members</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="club_details_history.php">History</a></td>
                  <td>A brief history of the North Ryde Soccer Club</td>
                </tr>
                </table>
              </td>
            </tr>
