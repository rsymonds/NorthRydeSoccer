<html>
<head>
  <title>North Ryde Soccer - Canteen</title>
      ...
      <td class="contentarea top">
        ...
        <tr>
          <td>
            ...
            <tr>
              <td class="forte">Canteen Menu</td>
            </tr>
            ...
            <tr>
              <td>
                <table class="fullwidth canteen" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="tablesubheader canteenmenuc1">SUBJECT</td>
                  <td class="tablesubheader canteenmenuc2">DESCRIPTION</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="canteen_menu.php">Menu</a></td>
                  <td>Price listings of the items that can be purchased at the canteen</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="canteen_roster.php">Roster</a></td>
                  <td>A calendar schedule of staff responsible for canteen duties</td>
                </tr>
                <tr>
                  <td><a class="tablelink" href="canteen_links.php">Links</a></td>
                  <td>Links to general information concerning the NRSC canteens</td>
                </tr>
                </table>
              </td>
            </tr>
