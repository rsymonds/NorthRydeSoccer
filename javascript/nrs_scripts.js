...
{
  var selectId = document.getElementById("archiveList");

  addArchive(selectId,"","Select another archive");
  addArchive(selectId,"archives_2008.html","2008");
  addArchive(selectId,"archives_2009.html","2009");
  addArchive(selectId,"archives_2010.html","2010");
  addArchive(selectId,"archives_2011.html","2011");
}
...
function addArchive(selectId,value,text)
{
