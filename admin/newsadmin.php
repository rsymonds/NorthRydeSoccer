...
<head>
  ...
  <script type="text/javascript" src="../Old_Site/javascript/nrs_scripts.js"></script>
  <link type="text/css" rel="stylesheet" href="../Old_Site/stylesheets/nrs_styles.css" />
...
<script type="text/javascript" src="../Old_Site/javascript/menu_variables_admin.js"></script>
<script type="text/javascript" src="../Old_Site/javascript/menu.js"></script>
...
<tr class="bgblue">
  <td>
    ...
    <!-- Site menu 
    <?php readfile("/Old_Site/topmenu.inc"); ?> 
     Spacer -->
